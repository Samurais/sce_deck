 ...
 */
public class StandardWindowsImageBuilder extends AbstractWindowsImageBuilder {
	protected static final String className = StandardWindowsImageBuilder.class
			.getName();

	public StandardWindowsImageBuilder(String bpmImageId, String bpmImageLoc,
