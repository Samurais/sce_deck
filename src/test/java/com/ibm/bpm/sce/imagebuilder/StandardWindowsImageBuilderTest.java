...
public class StandardWindowsImageBuilderTest extends TestCase {
	...
	public void testDevWindowsImageBuilder() {
		...
		StandardWindowsImageBuilder builder;
		try {
			builder = new StandardWindowsImageBuilder(bpmImageId, bpmImageLoc,
